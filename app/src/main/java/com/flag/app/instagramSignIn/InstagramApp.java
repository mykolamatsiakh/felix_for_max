...
import com.flag.app.MarkerActivity;
import com.flag.app.SignInActivity;
import com.flag.app.User;
import com.flag.app.instagramSignIn.InstagramDialog.OAuthDialogListener;
        ...
        public void fetchUserName(final Handler handler) {
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    handler.sendMessage(mHandler.obtainMessage(what, 2, 0));
                }
            }.start();
